...
Sources/Streaks/
  ...
  Views/TodayView.swift            Weekly summary card + progress ring + habit cards with check-off circles
  ...
  Components/WeeklySummaryCard.swift  Week-to-date rate + seven mini day rings (top of Today)
