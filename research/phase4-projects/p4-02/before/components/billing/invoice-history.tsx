...
const invoiceStatus: Record<InvoiceStatus, { label: string; tone: StatusTone }> = {
            ...
            <TableBody>
              {invoices.map((inv) => (
                <TableRow key={inv.id}>
                  ...
                  <TableCell>
                    <StatusBadge tone={invoiceStatus[inv.status].tone}>{invoiceStatus[inv.status].label}</StatusBadge>
                  </TableCell>
