...
import com.example.tv.ui.home.consumeFastDpadRepeat
import com.example.tv.ui.home.rememberRailPivotSpec
...
private fun RelatedRail(title: String, events: List<SportsEvent>, nowMin: Long, library: LibraryState, onOpen: (SportsEvent) -> Unit) {
    Column(Modifier.padding(bottom = SportsDimens.safeV)) {
        ...
        val holdClock = remember { LongArray(1) }   // same held-RIGHT pacing as the home rails
