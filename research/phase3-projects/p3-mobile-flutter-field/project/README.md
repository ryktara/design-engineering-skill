...
Screens: inspection checklist (`/inspection/:id`), defect report form (`/inspection/:id/defect/:itemId`), settings (`/settings`: sync frequency, units, high-contrast mode; reached from the checklist's More actions sheet).
