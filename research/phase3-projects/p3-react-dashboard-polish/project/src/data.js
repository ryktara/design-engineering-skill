...
// Alerts: /api/v2/sites/:id/alerts. `severity` is critical | warning; `acknowledged` is set by the user.
export const alerts = [
...
// Alerts that the socket pushes after first paint (simulated); the UI must announce them and must not shift the page.
export const incomingAlerts = [
  { after: 2000, alert: { id: "al-2202", severity: "warning", title: "Chiller plant demand above threshold", meter: "Chiller plant", detail: "812.9 kW against a 780 kW limit for 20 minutes.", since: "14:02", acknowledged: false } },
];
