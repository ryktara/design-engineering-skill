...
public static class SampleData
{
    ...
    /// <summary>When the ledger sync last completed (a real client would read this from the sync service).</summary>
    public static DateTime LastSync() => DateTime.Now.AddMinutes(-4);

    /// <summary>Postings the last sync could not write to the ledger.</summary>
    public static List<FailedPosting> FailedPostings() =>
    [
        new("GRN-2026-00812", "Cost centre DXB-OPS is closed for the period", DateTime.Now.AddMinutes(-4)),
        new("INV-2026-11907", "Tax code VAT-5 missing on 3 lines", DateTime.Now.AddMinutes(-4)),
    ];
}
