...
private val DarkColors = darkColorScheme(
    ...
    // Secondary text on the dark canvas. Grey600 (#6B6B6B on #121212) is 3.55:1 and
    // fails WCAG AA for body text; Grey400 is 7.8:1 and still reads as secondary
    // against onSurface (Grey100). Light mode keeps Grey700 on white (~9:1).
