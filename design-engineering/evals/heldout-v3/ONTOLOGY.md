# Concept ontology (public ids and labels) — concept-policy/v1

One id = one reusable design requirement. Use these ids in `required_concepts`, `recommended_concepts`, `forbidden_concepts`.
